    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full mx-auto max-w-7xl">
        <div class="flex flex-wrap mb-6 -mx-3">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                ...
                class="block appearance-none w-full bg-gray-200 border @error('description') border-red-500 @else @enderror  text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                ...
                class="block appearance-none w-full bg-gray-200 border @error('amount') border-red-500 @else @enderror  text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        ...
        <div class="w-full px-3 py-4 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 px-2 py-1 text-sm text-white bg-green-500 border-4 border-green-500 rounded hover:bg-green-700 hover:border-teal-700">Criar Registro</button>
        </div>
